...
model (``LibreSigLIP2._get_eval_transform``), the same transform ``predict()``
runs. Like :class:`CLIPClassifyValidator`, this class adds only:
...
class SigLIP2ClassifyValidator(ClassifyValidator):
    """Top-1/top-5 zero-shot validator for LibreSigLIP2."""
