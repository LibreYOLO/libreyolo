...
import numpy as np
import torch
from libreyolo.models.librevocab1.sam3.model.model_misc import SAM3Output
# LibreVocab1 vendor: sam1_task_predictor, perflib, and train were stripped from the
# upstream tree because they are not needed for the open-vocab inference path.
# Surviving references are either annotations (BatchedDatapoint) or guarded code
# paths (nms_masks under torch.profiler.record_function) that should not fire here.
