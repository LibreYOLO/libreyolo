...
def test_seg_filename_download_url_waits_for_pinned_revision(monkeypatch):
    ...
    assert LibreGTR.get_download_url("LibreGTRs-seg.pt") is None
    ...
    monkeypatch.setitem(LibreGTR.TASK_HF_REVISIONS["segment"], "s", "abc123")
    assert LibreGTR.get_download_url("LibreGTRs-seg.pt") == (
        "https://huggingface.co/LibreYOLO/LibreGTRs-seg/resolve/abc123/LibreGTRs-seg.pt"
    )
