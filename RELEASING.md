...
4. Use the GitHub release page to create and publish tag `vX.Y.Z` targeting `main`:
...
The publish workflow rejects release tags that are not reachable from `main`.
